...
namespace CosmicFood.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (role == StaticDetails.FrontDeskRole)
                            {
                                await _userManager.AddToRoleAsync(user, StaticDetails.FrontDeskRole);
                            }
                            else
                            {
